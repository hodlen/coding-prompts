...
Before returning, re-read HEAD and staged, unstaged, and untracked changes, including user progress and cleanup's edits. Report later changes as unreviewed. End with:
